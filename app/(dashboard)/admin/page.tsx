  ...
  return (
    <div className="animate-fluid pb-20 max-w-7xl mx-auto">
      ...
      <div className="px-6 space-y-10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 bg-card/40 p-2 rounded-3xl border border-white/5 backdrop-blur-md">
          <div className="flex gap-1">
            <Button
              variant="ghost"
              onClick={() => setActiveTab("bookings")}
              className={cn(
                "h-12 px-8 rounded-2xl font-black uppercase text-[10px] tracking-widest transition-all",
                activeTab === "bookings"
                  ? "bg-primary text-primary-foreground shadow-lg shadow-primary/20"
                  : "text-muted-foreground hover:bg-muted",
              )}
            >
              คิวจองที่รอดำเนินการ
            </Button>
            <Button
              variant="ghost"
          ...
          <div className="hidden sm:flex items-center gap-2 px-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Live Management System</span>
          </div>
        </div>
